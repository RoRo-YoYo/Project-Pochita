...
| Component | Status | Qty | Specifications | Est. Cost | Source | Notes |
| :--- | :---: | :--- | :---: | :--- | :--- | :--- |
| **DC Gearbox Motor** | ❌ To Buy| 1 | "TT Motor" (Yellow), 1:48 Ratio, 3-6V | $3.00 | [Amazon] | High torque is preferred over speed. |
| **Battery Holder** | ✅ Acquired | 1 | 4x AA Case with Cover & Switch| $2.00 | [AliExpress] | **Do not** use 9V batteries. Must be 6V total. |
| **DPDT Switch** | ✅ Acquired | 1 | Slide or Rocker (On-On) | $1.50 | [AliExpress] | Used for the reversing mechanism (Forward/Backward). |
| **Limit Switch** | ❌ To Buy| 1 | SPDT with Roller Lever | $1.00 | [Amazon/AliExpress] | Used as the pull-cord trigger. |
| **Wiring** | ❌ To Buy | - | 22 AWG Stranded Core | $10 | [Amazon/AliExpress] | Stranded wire is required for flexibility inside the plush. |
...
| **Washer/Bead** | ❌ To Buy | - | Large diameter | $3.00 | [Amazon/Hardware Store]  | Acts as the "stopper" to hit the limit switch roller. |
...
| **Felt / Fabric** | ❌ To Buy | 1 yd | Grey/Black (stiff felt) | $5.00 | [Amazon/AliExpress] | Used to create the soft chainsaw "chain" belt. |
